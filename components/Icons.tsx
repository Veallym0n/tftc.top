...
export const IconExplore = () => (
  <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="22.6708" cy="23.9159" r="8.3512"></circle>
    <circle cx="39.1357" cy="16.6557" r="4.3643"></circle>
    <circle cx="9.9553" cy="36.6314" r="5.4553"></circle>
    <path d="M19.1772,41.58A18.0224,18.0224,0,0,0,40.5563,25.98"></path>
    <path d="M33.6864,9.6758A18.0112,18.0112,0,0,0,5.0257,27.5032"></path>
  </svg>
);
...
export const IconSearch = () => (
  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z"></path></svg>
);
