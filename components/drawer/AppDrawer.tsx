...
const AppDrawer: React.FC<AppDrawerProps> = ({
  ...
  const tabs = [
    { id: 'data', label: '数据', icon: <IconData />, color: 'bg-memphis-yellow', textClass: 'text-yellow-700' },
    { id: 'tools', label: '工具', icon: <IconTools />, color: 'bg-memphis-pink', textClass: 'text-pink-700' },
    { id: 'settings', label: '设置', icon: <IconSettings />, color: 'bg-memphis-blue', textClass: 'text-cyan-700' },
    { id: 'links', label: '链接', icon: <IconLinks />, color: 'bg-memphis-green', textClass: 'text-emerald-700' },
    { id: 'about', label: '关于', icon: <IconInfo />, color: 'bg-memphis-purple', textClass: 'text-purple-700' },
  ];
